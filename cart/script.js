...
function printCheckList(cartProducts) {
  ...
  const checkOutContainer =
    document.getElementsByClassName("side-conatiner")[0];
  ...
  totalContainer1.innerHTML = `<div id="total-heading">Total(USD)</div>
  ...
  totalContainer2.innerHTML = `<div id="total-heading">Total(Rs.)</div>
